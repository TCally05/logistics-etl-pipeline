...
This is the first concrete piece of infrastructure work tied directly to the Palantir FDSE (Tactical Edge) and Defense Unicorns Data Engineer postings I'm targeting — both call out containerization, Kubernetes, and container security explicitly. A working, optimized Dockerfile with a documented security decision (non-root user) is something I can point to

q
stop


cat > docs/learning-log/day-04.md << 'EOF'
# Day 4 — Containerizing the pipeline with Docker
